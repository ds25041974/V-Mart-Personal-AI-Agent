        ...
        try:
            ...
            if file_summary:
                question_with_files = (
                    ...
                    "Reference files by name (e.g., 'from sales_report.csv') but do NOT display file contents, "
                    "data rows, or tables. Focus on presenting curated insights, metrics, and recommendations."
                )
            else:
